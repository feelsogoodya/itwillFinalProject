...
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/css/member/delete.css"
	type="text/css">
...
<form action="${pageContext.request.contextPath }/member/deletePro" method="POST" onsubmit="return validateForm()">
	<br>
	<div style="text-align: center;">
		<img src="/sample/resources/img/marketLogo.png" alt="" style="width: 200px;">
	</div>
	<br>
	<div id="wrap">
		<div id="header"></div>
...
<!-- 					</table> -->
				...
				<div class="dropout_agree_area">
					...
					<input type="checkbox" id="checkbox" name="dropoutAgree" > <label
