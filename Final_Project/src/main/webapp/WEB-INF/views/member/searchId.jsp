...
<body class="devicePC">
	<div class="container login" role="main">
		...
		<header data-system="CCommonAppbar" class="common-layout__sc-1q47zu5-0 bUzayd">
			<div class="common-layout__sc-1q47zu5-1 gKMDnM">
			
				<h2 class="common-layout__sc-wllrag-0 gZwINX">아이디 찾기 결과</h2>
				<div class="common-layout__sc-1q47zu5-2 common-layout__sc-1q47zu5-3 dTSzMK dckHmY">
				</div>
				<div
		...
		<section class="content content--middle">
						...
						<div class="text-center">
							<c:choose>
								...
								<c:otherwise>
									...
									<div class="login-find-result__result-item__membership-date">${searchVO.memTime} 가입</div>
								</c:otherwise>
							</c:choose>
			...
			<div class="login-button">
				<p class="login-button__link">
					비밀번호가 기억나지 않으세요? 
					<a href="passFind" class="login-button__link__link">비밀번호 찾기</a>
				</p>
